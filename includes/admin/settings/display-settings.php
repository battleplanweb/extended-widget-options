...
function widgetopts_options_page(){
     ...
     <div class="wrap">
		<h1>
			...
			<a href="<?php echo esc_url( apply_filters( 'widget_options_support_url', 'https://widget-options.com/contact/' ) ); ?>" target="_blank" class="page-title-action"><?php _e( 'Support', 'widget-options' ); ?></a>
		</h1>
